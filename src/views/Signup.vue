<template>
    <div class="text-center d-flex align-items-center full-height">
        <div class="d-flex flex-column mx-auto">
            ...
            <sui-card class="pt-3 mx-auto form-card">
                <sui-card-content>
                    <sui-card-header>
                        <h1 class="text-white text-left">Inscription</h1>
                    </sui-card-header>
                    <sui-card-description>                        
                        <sui-form method="post" v-on:submit.prevent="SignUp">
                            <sui-form-field>
                            ...
                            <sui-form-field>
                                ...
                                <input type="text" placeholder="Prénom" name="first_name" v-model="first_name" />
                            </sui-form-field>
                            <sui-form-field>
                                <label class="text-white text-left">Nom</label>
                                <input type="text" placeholder="Nom" name="last_name" v-model="last_name" />
                            </sui-form-field>
                            <sui-button v-if="!loading" fluid positive content="Inscription" type="submit" />
                            <sui-button v-else loading fluid positive content="Loading" />
                            <router-link to="/login" class="text-center d-block mt-3 text-white">Se connecter</router-link>
        ...
        SignUp() {
            ...
            this.$axios
              .post('/auth/signup', {
                  ...
                  imageUser: `http://gravatar.com/avatar/${md5(this.email)}?d=identicon`,
              })
              .then(res => {
